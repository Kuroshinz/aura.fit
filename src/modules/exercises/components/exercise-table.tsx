...
export const exerciseColumns: ColumnDef<ExerciseRecord>[] = [
  {
    accessorKey: 'name',
    ...
    cell: ({ row }) => {
      return (
        <div className="flex items-center gap-2">
          <button className="p-1.5 text-slate-400 hover:text-amber-400 hover:bg-amber-400/10 rounded-lg transition-colors">
...
export function ExerciseTable({ exercises }: ExerciseTableProps) {
  return <DataTable columns={exerciseColumns} data={exercises} />;
}
